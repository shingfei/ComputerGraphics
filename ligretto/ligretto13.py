# Spel, object-georienteerd, timer function
...
class Game:
    def __init__(self, noOfPlayers, msec):
        ...
        glutTimerFunc(msec, self.play, 0) # timer function
        glutMainLoop()
    ...
    def play(self, value): # aangeroepen door timer function       
        ...
        if self.ligretto == None:
            ...
            if value == len(self.players):
                value = 0
            glutTimerFunc(self.msec, self.play, value) # zet opnieuw de timer
        glutPostRedisplay() # vraagt systeem om draw() aan te roepen
